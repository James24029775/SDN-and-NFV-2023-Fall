...
public class DhcpConfig extends Config<ApplicationId> {
    ...
    public static final String SERVER = "serverLocation";

    @Override
    public boolean isValid() {
        return hasOnlyFields(SERVER);
    }

    public FilteredConnectPoint serverLocation() {
        String dhcpServerLocation = get(SERVER, null);
        String[] locationTuple = dhcpServerLocation.split("/");
